...
export function ScrollCameraController({ quality }) {
  ...
  useFrame((state) => {
    ...
    const layout = isMobile ? CAMERA_CONFIG.mobile : CAMERA_CONFIG.desktop;
    ...
    // Linear interpolation of scene components
    ...
    // Share scroll progress metrics in scene userData for adjacent components (NeuralCore, ParticleField)
